...
#define HITLS_CRYPTO_CURVE_SM2_ARMV7
#endif

#if defined(HITLS_CRYPTO_ECC_X8664) || defined(HITLS_CRYPTO_ECC_ARMV8) || defined(HITLS_CRYPTO_ECC_ARMV7)
...
#if defined(HITLS_CRYPTO_CURVE_SM2_X8664) || defined(HITLS_CRYPTO_CURVE_SM2_ARMV8) || defined(HITLS_CRYPTO_CURVE_SM2_ARMV7)
